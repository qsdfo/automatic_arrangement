...
class RBM(object):
    ...
    def sample_h_given_v(self,v0_sample):
        ...
        pre_sigmoid_h,h_mean = self.propup(v0_sample)
    ...
    def sample_v_given_h(self,h0_sample):
        ...
        pre_sigmoid_v,v_mean = self.propdown(h0_sample)
...
### Allows for quick test
def test_rbm(learning_rate=0.1, training_epochs=15,
             dataset='../../../Database/data/mnist.pkl.gz', batch_size=20,
