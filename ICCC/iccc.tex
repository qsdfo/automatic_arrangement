...
\begin{figure}
\centering
\includegraphics[scale=0.23]{FGCRBM_orchestration}
...
\begin{figure}
\centering
\includegraphics[scale=0.2]{FGCRBM_sampling}
...
In this section, we introduce and formalize the automatic projective orchestration of a piano score as presented in \prettyref{fig:orch}. In particular, we detail our data representation and how to 
...
\begin{figure}
\centering
\includegraphics[scale=0.4]{data_representation}
